...
class RegisterAdminController extends Controller
{
    ...
    /**
     * Muestra el formulario para crear un nuevo usuario con rol de administrador.
     *
     * @return \Illuminate\Http\Response
     */
    public function create()
    {
        // Retornar la vista 'Admin.RegisterAdmin' para crear un nuevo usuario con rol de administrador
        return view('Admin.RegisterAdmin');
    }

    /**
     * Almacena un nuevo usuario con rol de administrador en la base de datos.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\Response
     */
